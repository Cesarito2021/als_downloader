...
4. View A in **light purple** and B in **pale yellow**, on black. Red and blue are also available. Choose the earlier/later ordering from provider metadata. Rotate, zoom or show/hide either cloud; colours identify campaigns, not measured change.
