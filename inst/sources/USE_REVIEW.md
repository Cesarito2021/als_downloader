...
| IGN LiDAR HD | Retain IGN, the dataset link, Licence Ouverte 2.0 and UMR TETIS / INRAE for the discovery catalogue. [Licence](https://www.data.gouv.fr/pages/legal/licences/etalab-2.0). | Source and information-update date are attribution requirements. The adapter now preserves lidarhd:date_edition in each citation and checks it against the edition directory of the official IGN asset URL. The citation retains that exact source URL. Missing, invalid or conflicting editions stop the IGN search explicitly; acquisition dates and catalogue creation timestamps are never substituted. A live item verified on 20 September 2026 reported edition 2026-04-30 and acquisition 2025-10-18. This is a product-edition attribution, not a claim that every tile was independently audited. |
