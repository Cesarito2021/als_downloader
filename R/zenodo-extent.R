...
zenodo_square <- function(longitude,latitude,distance_m,file_keys) {
  ...
  if(!scalar(distance_m)||distance_m<1||distance_m>10000)
    stop("Distance from centre to each side must be 1 to 10,000 metres (10 km). For larger areas, provide coverage polygons.")
